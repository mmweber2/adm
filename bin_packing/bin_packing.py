def bin_pack(item_sizes, capacity):
    ...
    For each item in item_sizes, place it in the first box that has room for it.
    If none of the boxes have room, create a new box.

    Args:
        item_sizes: list of item sizes (numbers) to pack.
            All sizes must be in the range 0 < size <= capacity.

        capacity: number, the capacity of a single box.
